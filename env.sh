conda remove -n morphosim --all -y
conda create -n morphosim python=3.10 -y

source activate morphosim
...
pip install torch-sparse -f https://data.pyg.org/whl/torch-2.4.1+cu118.html ### sz
pip install torch-scatter -f https://data.pyg.org/whl/torch-2.4.1+cu118.html ### sz
pip install torch-cluster -f https://data.pyg.org/whl/torch-2.4.1+cu118.html ### sz
...
# pip install git+https://github.com/mhapip install torch-sparse -f https://data.pyg.org/whl/torch-2.4.1+cu118.htmlmilton723/CLIP.git
