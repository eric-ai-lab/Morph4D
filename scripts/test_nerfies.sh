...
data_root=/public/home/renhui/code/4d/feature-4dgs/data/nerfies/${dataset_name}
gt_root=/public/home/renhui/code/4d/feature-4dgs/data/nerfies/${dataset_name}/right1
python test.py --config ./configs/nerfies/nerfies.yaml --root ${exp_root} --src ${data_root} --tto
