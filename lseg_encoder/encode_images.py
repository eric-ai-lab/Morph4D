import os
# os.environ["http_proxy"] = "http://localhost:22334"
# os.environ["https_proxy"] = "http://localhost:22334"
import argparse
import numpy as np
...
def test(args):
    ...
    f.close()
    # save time log json file:

    with open(os.path.join(outdir, "lseg_encode_time.json"), "w") as f:
        json.dump({"encode_time": encode_time, "inference_time": inference_time}, f)
