...
class LDM3D_SDS(nn.Module):
    ...
    def train_step(
        ...
        loss = (
            0.5
            * F.mse_loss(latents.float(), target, reduction=reduction)
            / latents.shape[0]
        )
    ...
    def produce_latents(
        ...
        embeddings = embeddings.to(latents)
...
if __name__ == "__main__":
    ...
    sd = LDM3D_SDS(device, opt.fp16, opt.vram_O, opt.sd_version, opt.hf_key)
